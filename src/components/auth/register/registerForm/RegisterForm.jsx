    ...
    return (
        <div className="text-center register-container">
            ...
            <form onSubmit={handleSubmit}>
                <div className='my-4'>
                    <div className={errors.username && touched.username ? "register-input-icon-container-error" : "register-input-icon-container"}>
                ...
                <div className='my-2'>
                    <div className={errors.email && touched.email ? "register-input-icon-container-error" : "register-input-icon-container"}>
                        <div className="d-flex align-items-center">
                            <svg
                                width="24"
                                height="24"
