...
const RegisterForm = () => {
  ...
  return (
    ...
    //     <form >
    //       <div className="text-start title-login-and-signup mb-4">Sign Up for an Account</div>
    //       <div className="mt-3">
    //         <div className=''>
    //           <div className={errors.password && touched.password ? "input-box-container-error" : "input-box-container"}>
    //             <div className='d-flex align-items-center'>
    //               <div>
    //                 <svg className="ms-1" width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    //                   <path d="M7 9C9.20914 9 11 7.20914 11 5C11 2.79086 9.20914 1 7 1C4.79086 1 3 2.79086 3 5C3 7.20914 4.79086 9 7 9Z" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    //                   <path d="M1 19V17C1 15.9391 1.42143 14.9217 2.17157 14.1716C2.92172 13.4214 3.93913 13 5 13H9C10.0609 13 11.0783 13.4214 11.8284 14.1716C12.5786 14.9217 13 15.9391 13 17V19" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    //                 </svg>
    ...
    //       </div>
    //       <div>
    //         <div className="very-small-text mt-3">Your password must have at least 8 characters</div>
    //         <div className="d-flex my-4">
    //           <div>
    //             <input type="checkbox" />
    //           </div>
    //           <div className="ms-2 very-small-text">
    //             By creating an account means you agree to the <b className="text-black">Terms
    //               & Conditions</b> and our <b className="text-black">Privacy Policy</b>
    //           </div>
    //         </div>
    //       </div>
    //       <button className="my-4 button">Sign Up</button>
    //       <div className="my-4 d-flex align-items-center justify-content-center">
    //         <div>
    //           <svg
    //             className="sign-in-with-line"
    ...
    //         />
    //       </div>
    //       <div className="text-center small-text my-4">Already have an account? <Link className="Link-tag">Log In</Link></div>
    //     </form>
    //   </div>
    // </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="d-flex mt-4">
                ...
                <div className="ms-2 very-small-text">By creating an account means you agree to the <b className="text-black">Terms</b><b className="text-black">& Conditions</b>
                  <br />
                  and our <b className="text-black">Privacy Policy</b></div>
              </div>
              <div>
                {errors.TermsAndConditions && touched.TermsAndConditions ? (
                  <div className="d-flex mt-1 align-items-center text-start text-pink">
